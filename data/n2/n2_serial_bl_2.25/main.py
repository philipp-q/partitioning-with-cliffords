...
max_epochs = 10 # num_epochs, max number of iterations
min_epochs = 2  # num_epochs, max number of iterations5
# min_epochs = 20  # num_epochs, max number of iterations
tol = 1e-5       # minimum change in energy required, otherwise terminate optimization
